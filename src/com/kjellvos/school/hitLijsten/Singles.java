 ...
 */
public class Singles implements SceneImplementation {
    ...
    public Singles(MainMenu mainMenu) {
    ...
    public Scene createAndGetScene() {
        ...
        zoekButton.setOnMouseClicked(event -> {
            tableView.setItems(mainMenu.getDatabase().getNotatieBijTitel(zoekTextField.getText()));
        });
        ...
        gridHandler.add(0, 1, new Label("Zoeken op single titel:"), 3, 1, false);
        ...
        gridHandler.add(8, 5, artiestenButton, 1, 4, false);
